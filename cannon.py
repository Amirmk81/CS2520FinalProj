...
class Cannon():
    ...
    class Target():
        ...
        def check_collision(self, ball):
            ...
            '''
            dist = sum([(self.coord[i] - ball.coord[i])
                       ** 2 for i in range(2)]) ** 0.5
    ...
    class Manager:
        ...
        def new_mission(self):
            ...
            for i in range(self.n_targets):
                self.guns.append(Cannon(
                    coord=[SCREEN_SIZE[0] - 30, SCREEN_SIZE[1] // 2], angle=np.pi, color=rand_color()))

        def process(self, events, screen):
            '''
            Runs all necessary methods for each iteration. Adds new targets if the previous ones are destroyed.
            '''
        ...
        def draw(self, screen):
            '''
            Runs balls', guns', targets', and score table's drawing methods.
            '''
        ...
        def move(self):
            '''
            Runs balls' and guns' movement methods, removes dead balls.
            '''
            dead_balls = []
